...
include("../scr/isfpolymodel.jl")
include("../scr/polymethods.jl")
...
#     mpar, mexp = PolyModelToISF(U, S)
    ...
    function cb(x)
        ...
        println("       umat norm:      ", sqrt(sum(umat.^2)))
...
include("../scr/mapmethods.jl")
    ...
    for order in [3 5 7]
        ...
        @save "MapFitShawPierreS$(SIGMA)O$(order).bson" DT Wo1 Ro1 Ws1 Rs1 W1 R1 U1 S1 mpar1 mexp1
        ...
        @save "MapFitShawPierreS$(SIGMA)O$(order).bson" DT Wo1 Ro1 Ws1 Rs1 W1 R1 U1 S1 mpar1 mexp1 Wo2 Ro2 Ws2 Rs2 W2 R2 U2 S2 mpar2 mexp2
    end
    end
