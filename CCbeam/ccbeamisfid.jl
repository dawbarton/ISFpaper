...
for SIGMA in [1]
    for order in [3 5 7]
        ...
        # OPTIMISATION STARTS
        #----------------------------------------------
        U1, S1, mpar10, mexp10 = ISFData(xs, ys, DF, [1,2], 3, order, SIGMA, dt=DT, rmax=0.7, onlyU = true, steps = 300)
        U1, S1, mpar1, mexp1 = ISFData(xs, ys, DF, [1,2], 3, order, SIGMA, dt=DT, rmax=0.7, mpar0 = mpar10, mexp0 = mexp10)
        ...
        # OPTIMISATION STARTS
        #----------------------------------------------
        U2, S2, mpar20, mexp20 = ISFData(xs, ys, DF, [3,4], 3, order, SIGMA, dt=DT, rmax=0.7, onlyU = true, steps = 300)
        U2, S2, mpar2, mexp2 = ISFData(xs, ys, DF, [3,4], 3, order, SIGMA, dt=DT, rmax=0.7, mpar0 = mpar20, mexp0 = mexp20)
        ...
        # OPTIMISATION STARTS
        #----------------------------------------------
        U3, S3, mpar30, mexp30 = ISFData(xs, ys, DF, [5,6], 3, order, SIGMA, dt=DT, rmax=0.7, onlyU = true, steps = 300)
        U3, S3, mpar3, mexp3 = ISFData(xs, ys, DF, [5,6], 3, order, SIGMA, dt=DT, rmax=0.7, mpar0 = mpar30, mexp0 = mexp30)
